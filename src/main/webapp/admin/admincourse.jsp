        ...
        <div class="dashboard-wrapper">
            <aside class="sidebar">
                ...
                <nav class="nav-menu">
                    ...
                    <a href="${pageContext.request.contextPath}/CourseServlet" class="nav-link active"><i class="fas fa-book-open"></i> Manage Courses</a>
            ...
            <main class="main-content">
                ...
                <div class="schedule-container" style="margin-bottom: 20px;">
                    ...
                    <form action="${pageContext.request.contextPath}/CourseServlet" method="POST" style="display: flex; gap: 10px; margin-top: 15px; flex-wrap: wrap; align-items: center;">
                        ...
                        <input type="text" name="courseCode" placeholder="Code (e.g. IT101)" required style="padding: 8px; border-radius: 5px; border: 1px solid #ddd; width: 120px;">
                        <input type="text" name="courseName" placeholder="Course Name" required style="padding: 8px; border-radius: 5px; border: 1px solid #ddd; flex: 2;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <form action="${pageContext.request.contextPath}/CourseServlet" method="POST">
                                        ...
                                        <button type="submit" class="btn-reject" onclick="return confirm('Delete this course?')">
